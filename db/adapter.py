...
# import db.repositories as db_manager
#
#
# # split into 'DBUserRepository' and 'DBDishRepository'
...
#     #     return dish_repr
#
#     def _to_user_model(self, tg_user: UserDTO) -> Optional[UserModel]:
#         return UserModel(**asdict(tg_user))
#
#     def _to_telegram_user(self, user_model: UserModel) -> UserDTO:
...
#
#     def save_dish(self, dish: DishDTO, user: UserDTO) -> None:
